...
const PoweredBy = () => (
  <div className="mt-24 text-center px-4">
    ...
    <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-8 flex-wrap">
      <img src={chatgpt_logo} alt="ChatGPT" className="w-24 sm:w-32 md:w-48 object-contain" />
      <img src={drugbank_logo} alt="DrugBank" className="w-24 sm:w-32 md:w-48 object-contain" />
      <img src={pubmed_logo} alt="PubMed" className="w-24 sm:w-32 md:w-48 object-contain" />
    </div>
  </div>
);
