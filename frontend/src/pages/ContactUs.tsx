  ...
  return (
    <Container maxWidth="md" sx={{ flexGrow: 1, py: 6 }}>
      ...
      >
        ...
        <Typography variant="body1" color="text.secondary">
          Whether you've got a question, a suggestion, a crazy idea, or just want to say hello (and
          hey, we love that too), no one here will judge your curiosity—we're huge fans of it.
        </Typography>
        <Typography variant="body1" color="text.secondary">
